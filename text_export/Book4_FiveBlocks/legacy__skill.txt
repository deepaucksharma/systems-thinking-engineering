...
> [!WARNING]
> This is a fragmented legacy metric page. For the complete V2.1 unified Execution layer, see **[12 — Block E (Execution System)]()** and **[13 — Block A (Org Alignment)]()** for how Composition and Interactions limit pure capability.
...
- "We don't have the skills" may be a literal composition problem ($TC_{gap}$). In this case, pulling the local coaching/development lever will fail; you must escalate for hiring/restructuring via the [Lever-Access Rule]().
...
See [Structure-vs-Development Rule](): when you can't tell if the problem is Skill or [Coordination](../legacy/coordination.md), fix Structure first — coordination failures mask true skill levels.

## Related

- [Coordination](../legacy/coordination.md) — the parallel condition at the same fix-order level
- [Structure-vs-Development Rule]() — disambiguation rule
