...
backlinks: [wiki/sources/diagram-set-1.md, wiki/sources/diagram-set-2.md, wiki/sources/4-visual-architecture.md, wiki/concepts/utilization-curve.md]
created: 2026-04-08
updated: 2026-04-08
status: active
---
...
- [Focus](focus.md) — the condition that controls WIP
